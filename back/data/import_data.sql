...
INSERT INTO "wine"("name", "description", "appellation", "size","price", "alcohol", "vintage", "color", "region_id", "winemaker_id")VALUES
('Le bon petit vin', 
"Ce vin fruité et minéral présente une belle fraîcheur en bouche et des tanins fondus. Un vin idéal pour accompagner vos planches de charcuterie, de fromages ou encore vos barbecue.", 
...
("Daï", 
"Ce vin rosé est un OVNI qui n'a rien à envié aux autres rosés de Provence ! Un rosé avec du caractère ! Il dévoile des notes de fruits à noyaux (abricot), de fruits rouges (framboise) ou encore de fruits noir (myrtille, groseille). Ample, sur le fruit et frais ! Que demander de plus ? Parfait pour l'été !",
